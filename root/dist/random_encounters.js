...
export function setRecentlyEscaped(escaped) {
    recentlyEscaped = escaped;
}
export async function checkForRandomEncounter(state, locationName) {
...
async function triggerLocationSpecificEncounter(state, locationName) {
    try {
